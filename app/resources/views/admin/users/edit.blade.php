    ...
    <div>
        <form method='post' action="{{ route('admin.users.update', ['user'=> $user]) }}">
            ...
            <div class="form-group">
                ...
                <input type="radio" id="is_admin" name="is_admin" @if($user->is_admin) checked @endif value="1">
                <br>
                <label for="just_user">Пользователь</label>
                <input type="radio" id="just_user" name="is_admin" @if(!$user->is_admin) checked @endif value="0">
            </div>
{{--            <div class="form-group">--}}
