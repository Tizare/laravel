...
<?php if ($news['0']['category_id'] == 1): ?>
        <h2>Новости культуры</h2>
    <?php elseif ($news['0']['category_id'] == 2): ?>
        <h2>Новости кино</h2>
    <?php elseif ($news['0']['category_id'] == 3): ?>
        <h2>Новости спорта</h2>
    <?php elseif ($news['0']['category_id'] == 4): ?>
        <h2>Игровые новости</h2>
    <?php elseif ($news['0']['category_id'] == 5): ?>
